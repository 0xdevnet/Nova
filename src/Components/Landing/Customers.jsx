    ...
    return (
        <div style={customerSectionContainerStyle}>
            ...
            <div style={customerStepContainerStyles(width)}>
                ...
                <CustomerCard image="https://paganresearch.io/images/terraformlabs.png" paragraph="2. Stake MINE token for a chance to win NFT content drops from your favorite creators."/>
